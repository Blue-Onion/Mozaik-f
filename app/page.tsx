...
const feat = [
  {
    ...
    description:
      "Turn any concept, sketch, or reference into polished, cinematic visuals with ease.",
    link: "/main.mp4",
  },
  {
    ...
    description:
      "Adjust colors, timing, motion, style, and layout — every detail is editable to match your vision.",
    link: "/main.png",
  },
];
          ...
          <div className="mx-auto flex flex-col items-center justify-center container space-y-8">
            <div className="flex flex-col items-center justify-center gap-5">
              ...
              <p className="text-muted-foreground text-center max-w-4xl">
                ManimFlow helps you turn math, diagrams, and concepts into
                smooth, professional animations without breaking your head over
                boilerplate code.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-32 w-full">
              {feat.map((f, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="group rounded-2xl bg-linear-to-b from-white to-blue-50 border border-gray-200 shadow-sm hover:shadow-xl hover:border-indigo-300 transition-all duration-300 bg-gray-300 backdrop-blur-sm"
                  >
                    <div
